...
### ③ index.htmlから自由記入欄(上段・下段)を削除【ローカル完成・GitHubアップロード待ち】
...
- **次アクション：** ローカルミラーの`invoice-builder/index.html`をGitHubにアップロードして反映する。
...
- **セッション開始の合言葉**：「invoice-builder-CONTEXT.mdとdeveloper-profile-updated.mdを読み込んで(フォルダ優先、未接続ならGitHubから)」
